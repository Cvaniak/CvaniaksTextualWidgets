...
silent only
silent tabonly
cd ~/OpenSource/CvaniaksTextualWidgets/ck_widgets/color
...
badd +42 ~/OpenSource/CvaniaksTextualWidgets/ck_widgets/color/color_tools.py
...
badd +0 ~/OpenSource/CvaniaksTextualWidgets/NERD_tree_1
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 42 - ((23 * winheight(0) + 27) / 54)
